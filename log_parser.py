...
def parse_log_to_csv(log_file_path, output_dir):
    ...
    try:
        ...
        print(f"An error occurred during file parsing: {e} on line {line_num}. ⚠️")
    ...
    for file_key, records in sensor_data_csvs.items():
        ...
        print(f"✅ Successfully created {output_file_path} for {len(records)} entries.")
    ...
    if category_timing_data:
        ...
        print(f"✅ Successfully created {output_file_path} for {len(category_timing_data)} entries.")
    else:
        print("No category timing data found to write. 📋")
    ...
    if command_response_data:
        ...
        print(f"✅ Successfully created {output_file_path} for {len(command_response_data)} entries.")
    else:
        print("No command response data found to write. 📋")
